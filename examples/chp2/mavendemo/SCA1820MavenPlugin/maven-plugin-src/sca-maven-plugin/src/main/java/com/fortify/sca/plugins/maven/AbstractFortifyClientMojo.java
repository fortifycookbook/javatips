...
public abstract class AbstractFortifyClientMojo extends AbstractFortifyMojo {
    ...
    /**
     * Specifies the SSC project name.
     * Note that this must be supplied in conjunction with sscProjectVersion.
     * @deprecated Use sscApplicationName instead
     */
    @Parameter(property = "fortify.ssc.projectName", alias = "fortify.f360.projectName")
    protected String sscProjectName;
    ...
    /**
     * Specifies the SSC project version.
     * Note that this must be supplied in conjunction with sscProjectName.
     * @deprecated Use sscApplicationVersion instead
     */
    @Parameter(property = "fortify.ssc.projectVersion", alias = "fortify.f360.projectVersion")
    protected String sscProjectVersion;
    ...
    /**
     * Specifies the Project Version ID of the SSC project.
     * Note that sscProjectVersionId overrides sscProjectName and sscProjectVersion combinations if supplied.
     * @deprecated Use sscApplicationVersionId instead
     */
    @Parameter(property = "fortify.ssc.projectVersionId", alias = "fortify.f360.projectVersionId")
    protected String sscProjectVersionId;
