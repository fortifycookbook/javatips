...
public abstract class AbstractSCAMojo extends AbstractFortifyMojo {
    ...
    protected List<String> buildOptions() {
        ...
        OptionUtil.setProperty(options, "com.fortify.WorkingDirectory", fortifyWorkingDirectory);
        OptionUtil.setProperty(options, "com.fortify.sca.ProjectRoot", scaProjectRoot);
